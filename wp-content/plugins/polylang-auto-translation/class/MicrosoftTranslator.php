...
class MicrosoftTranslation extends TranslationApi {
    ...
    public function translate($string, $from, $to) {
        ...
        $translator = new MicrosoftTranslator('lmTu4nxYp2d+J+gcJxZBB1Z7d0SGXg0plvZvNm1c64g=');
        $translator->translate($from, $to, $string);
        if($translator->response->status == MicrosoftTranslator::SUCCESS) {
            
            
            preg_match('/<string.*?>(.*)<\/string>/is', $translator->response->translation, $matches);
...
/*
$translation = new MicrosoftTranslation();
echo $translation->translate("Bonjour le monde !", "fr", "en");
*/